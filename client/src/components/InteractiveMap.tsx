...
const communities = [
  { name: "San Jose, CA", kits: 45, lat: 37.3382, lng: -121.8863, region: "Bay Area" },
  { name: "Oakland, CA", kits: 32, lat: 37.8044, lng: -122.2711, region: "Bay Area" },
  { name: "San Francisco, CA", kits: 28, lat: 37.7749, lng: -122.4194, region: "Bay Area" },
  { name: "Los Angeles, CA", kits: 67, lat: 34.0522, lng: -118.2437, region: "Southern California" },
  { name: "San Diego, CA", kits: 23, lat: 32.7157, lng: -117.1611, region: "Southern California" },
  { name: "Sacramento, CA", kits: 19, lat: 38.5816, lng: -121.4944, region: "Central Valley" },
  { name: "Fresno, CA", kits: 15, lat: 36.7378, lng: -119.7871, region: "Central Valley" },
  { name: "Seattle, WA", kits: 21, lat: 47.6062, lng: -122.3321, region: "Pacific Northwest" },
  { name: "Portland, OR", kits: 18, lat: 45.5152, lng: -122.6784, region: "Pacific Northwest" },
  { name: "Phoenix, AZ", kits: 26, lat: 33.4484, lng: -112.0740, region: "Southwest" },
  { name: "Las Vegas, NV", kits: 14, lat: 36.1699, lng: -115.1398, region: "Southwest" },
  { name: "Denver, CO", kits: 22, lat: 39.7392, lng: -104.9903, region: "Mountain West" }
];

const regions = [
  { name: "Bay Area", color: "from-pink-400 to-purple-500", total: 105 },
  { name: "Southern California", color: "from-purple-400 to-blue-500", total: 90 },
  { name: "Central Valley", color: "from-blue-400 to-teal-500", total: 34 },
  { name: "Pacific Northwest", color: "from-teal-400 to-green-500", total: 39 },
  { name: "Southwest", color: "from-orange-400 to-pink-500", total: 40 },
  { name: "Mountain West", color: "from-purple-500 to-pink-500", total: 22 }
];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            See where we've delivered self-care kits and helped young girls build confidence across the West Coast and beyond.
          </p>
        </div>
